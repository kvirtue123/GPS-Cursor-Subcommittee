...
# Agent Script Example: Ground Your Agent With Updated Terminology
...
![ADL ready](../../../../../../media/agent-script/rag-example/ADL_ready.png)
...
![ADL ready](../../../../../../media/agent-script/rag-example/agent_perms.png)
:::note
...
4. In the field Alternate Product Names, paste the entire contents of the `Aura & Ash New Names.pdf`, including the instructions.
   ![script added](../../../../../../media/agent-script/rag-example/new_knowledge.png)
5. Click **Save**.
...
![script added](../../../../../../media/agent-script/rag-example/article_number.png)
...
```sfdocs-code {"lang":"agentscript", "title": "Action Script (REPLACE ARTICLE NUMBER WITH YOURS)"}
...
![script added](../../../../../../media/agent-script/rag-example/action_script.png)

5. Save the agent, then verify in Canvas view.

![script added](../../../../../../media/agent-script/rag-example/action_script_canvas.png)
...
![canvas view](../../../../../../media/agent-script/rag-example/variable_canvas_view.png)
...
![Final query](../../../../../../media/agent-script/rag-example/final_utterance.png)
